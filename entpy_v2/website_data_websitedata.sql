...
(6, 'classic_index_first_content', '<div class="col-md-4"><div class="feature-left"><div><h3>Titolo1</h3><p>Facilis ipsum reprehenderit nemo molestias. Aut cum mollitia reprehenderit.</p></div></div></div><div class="col-md-4"><div class="feature-left"><div><h3>Titolo2</h3><p>Facilis ipsum reprehenderit nemo molestias. Aut cum mollitia reprehenderit.</p></div></div></div><div class="col-md-4"><div class="feature-left"><div><h3>Titolo3</h3><p>Facilis ipsum reprehenderit nemo molestias. Aut cum mollitia reprehenderit.</p></div></div></div>', 1),
...
(32, 'classic_services_first_service_list', '<ul><li>Nome servizio1</li><li>Nome servizio2</li><li>Nome servizio3</li><li>Nome servizio4</li></ul>', 1),
(33, 'classic_services_second_service_title', 'Titolo paragrafo2', 1),
(34, 'classic_services_second_service_content', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Totam quae modi earum eligendi eaque quis laudantium aperiam sunt atque recusandae, fugiat veritatis repellendus incidunt nostrum voluptatibus. Eveniet ex magnam repellat sunt molestiae, quibusdam culpa dignissimos recusandae voluptatum necessitatibus provident commodi?', 1),
(35, 'classic_services_second_service_list', '<ul><li>Nome servizio5</li><li>Nome servizio6</li><li>Nome servizio7</li><li>Nome servizio8</li></ul>', 1),
